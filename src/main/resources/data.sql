CREATE INDEX idx_route_name ON routes (name);
CREATE INDEX idx_bus_stop_name ON bus_stops (name);
CREATE INDEX idx_date ON reservation (reservation_date);

-- prepare data for the routes and buses:
